namespace Deliveries
{
    partial class FillForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            lbDelete = new Label();
            menu = new MenuStrip();
            showPanels = new ToolStripMenuItem();
            showFilter = new ToolStripMenuItem();
            showDelete = new ToolStripMenuItem();
            showUpdate = new ToolStripMenuItem();
            ...
            menu.Items.AddRange(new ToolStripItem[] { showPanels });
            menu.Location = new Point(0, 0);
            menu.Name = "menu";
            menu.Size = new Size(1183, 33);
            menu.TabIndex = 37;
            menu.Text = "menuStrip2";
            // 
            // showPanels
            // 
            showPanels.DropDownItems.AddRange(new ToolStripItem[] { showFilter, showDelete, showUpdate });
            showPanels.Name = "showPanels";
            showPanels.Size = new Size(77, 29);
            showPanels.Text = "Panels";
            // 
            // showFilter
            // 
            showFilter.Checked = true;
            showFilter.CheckState = CheckState.Checked;
            showFilter.Name = "showFilter";
            showFilter.Size = new Size(270, 34);
            showFilter.Text = "Filter";
            showFilter.Click += showFilter_Click;
            // 
            // showDelete
            // 
            showDelete.Checked = true;
            showDelete.CheckState = CheckState.Checked;
            showDelete.Name = "showDelete";
            showDelete.Size = new Size(270, 34);
            showDelete.Text = "Delete";
            showDelete.Click += showDelete_Click;
            // 
            // showUpdate
            // 
            showUpdate.Checked = true;
            showUpdate.CheckState = CheckState.Checked;
            showUpdate.Name = "showUpdate";
            showUpdate.Size = new Size(270, 34);
            showUpdate.Text = "Update";
            showUpdate.Click += showUpdate_Click;
            // 
            // panelUpdate
            // 
        ...
        private ToolStripMenuItem showPanels;
        private ToolStripMenuItem showFilter;
        ...
        private ToolStripMenuItem showDelete;
        private Panel panelDelete;
        private Label lbDelete;
        private Button btnDelete;

        private ToolStripMenuItem showUpdate;
